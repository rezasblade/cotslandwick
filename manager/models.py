...
class Player(models.Model):
    ...
    preferredfoot = models.CharField(max_length=50, default='Right')
    position = models.CharField(max_length=20, default='Defender')
    trait = models.CharField(max_length=50, default='Pays on time')
    points = models.IntegerField(default=0)
    goalsscored = models.IntegerField(default=0)
    assists = models.IntegerField(default=0)
    motmawards = models.IntegerField(default=0)
    fantasypoints = models.IntegerField(default=0)

    def __str__(self):
        return f"{self.name} - {self.preferredfoot}"
        # return f"{self.name}"
